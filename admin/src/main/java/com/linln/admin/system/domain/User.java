...
public class User implements Serializable {
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", salt=" + salt + ", nickname="
				+ nickname + ", picture=" + picture + ", sex=" + sex + ", phone=" + phone + ", email=" + email
				+ ", createDate=" + createDate + ", updateDate=" + updateDate + ", remark=" + remark;
	}
